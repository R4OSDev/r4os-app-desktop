...
pub const UiTarget = enum(u16) {
    ...
    volume_output_2 = 129,
    volume_output_3 = 130,
    volume_output_auto = 131,
    volume_output_previous = 132,
    volume_output_next = 133,
    volume_popup_surface = 134,
    start_button = 140,
...
pub const ps_constants = [_]PsConstant{
    ...
    .{ .name = "UiTargetMenuScreenOff", .value = @intFromEnum(UiTarget.menu_screen_off) },
    ...
    .{ .name = "UiTargetVolumeOutput0", .value = @intFromEnum(UiTarget.volume_output_0) },
    .{ .name = "UiTargetVolumeOutput1", .value = @intFromEnum(UiTarget.volume_output_1) },
    .{ .name = "UiTargetVolumeOutput2", .value = @intFromEnum(UiTarget.volume_output_2) },
    .{ .name = "UiTargetVolumeOutput3", .value = @intFromEnum(UiTarget.volume_output_3) },
    .{ .name = "UiTargetVolumeOutputAuto", .value = @intFromEnum(UiTarget.volume_output_auto) },
    .{ .name = "UiTargetVolumeOutputPrevious", .value = @intFromEnum(UiTarget.volume_output_previous) },
    .{ .name = "UiTargetVolumeOutputNext", .value = @intFromEnum(UiTarget.volume_output_next) },
    .{ .name = "UiTargetVolumePopupSurface", .value = @intFromEnum(UiTarget.volume_popup_surface) },
